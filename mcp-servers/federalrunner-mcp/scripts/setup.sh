#!/bin/bash
#
# FederalRunner Development Setup
#
...
echo "========================================"
echo "FederalRunner Development Setup"
echo "========================================"
echo ""
...
echo "  Installing WebKit (FSA-compatible headless)..."
python -m playwright install webkit
echo "  Installing Chromium (debugging)..."
...
echo "  2. Run all tests:  ./run_tests.sh"
echo "  3. Or run manually: pytest tests/test_execution_local.py -v"
echo "  4. See README.md for more options"
echo ""
